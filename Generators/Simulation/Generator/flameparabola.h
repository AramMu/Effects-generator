#ifndef FLAMEPARABOLA_H
#define FLAMEPARABOLA_H
 ...
 * rate + func/2 + speed/3
*/
class FlameParabola : public AbstractSimulation {
public:
    enum MergeMode {
    ...
    explicit FlameParabola(const cv::Size& size);
...
private:
    ...
    std::vector <Parabola> mParabolas;
